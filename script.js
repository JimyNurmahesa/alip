const CONFIG = {
  ...
  subQuestion: 'Yes lahh masa nggaaa ',
  yesButton: 'YES',
  noButton: 'NO',
  noEscapeTexts: ['Kok No Sii 😡', 'Jangan No Sayanggg 😑', 'Bodo Amat Yg Penting YESSSS ya! 💕'],
  ...
  flowerTitle: 'Ini kado spesial buat kamu, walaupun Virtual Semoga kamu sukaa 😊 ',
  takeBouquetButton: 'Terima hadiahnya ',
  bouquetMessage: 'Yeay! Udah Punya kamu Sekarang 💕',
